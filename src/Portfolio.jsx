...
function PhoneIcon(props) {
  return (
    <Icon {...props}>
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.32 1.77.6 2.61a2 2 0 0 1-.45 2.11L8 9.8a16 16 0 0 0 6.2 6.2l1.36-1.26a2 2 0 0 1 2.11-.45c.84.28 1.71.48 2.61.6A2 2 0 0 1 22 16.92Z" />
    </Icon>
  );
}
      ...
      <header className="pf-container pf-hero">
        ...
        <div className="pf-cta-row">
          <button className="pf-btn primary" onClick={() => scrollTo("projects")}>
            View projects <ArrowUpRightIcon size={15} />
          </button>
        ...
        <section id="contact" className="pf-section pf-contact">
          ...
          <div className="pf-contact-links">
            <a className="pf-contact-link" href="mailto:srinivasgowda1299@gmail.com">
              <MailIcon size={16} /> srinivasgowda1299@gmail.com
            </a>
            <a className="pf-contact-link" href="tel:7776978017">
              <PhoneIcon size={16} /> +91 77769 78017
            </a>
            <a className="pf-contact-link" href="https://linkedin.com/in/srinivas-gowda" target="_blank" rel="noreferrer">
              <LinkedinIcon size={16} /> linkedin.com/in/srinivas-gowda <ExternalLinkIcon size={12} />
            </a>
            <span className="pf-contact-link">
              <MapPinIcon size={16} /> Bengaluru, India
            </span>
          </div>
        </section>
      </main>
